...
{
	private chronicleCardPainter: ChronicleCardPainter;

	constructor(chronicleCardPainter: ChronicleCardPainter)
	{
		super();

		this.chronicleCardPainter = chronicleCardPainter;
	}
	...
	async execute(interaction: any)
	{
		...
		const reply: DiscordEmbedDto = await this.chronicleCardPainter.buildCard(card, async status => { await interaction.editReply(status); });
